    ...
    <div class="sidebar">
        ...
        @if($rooms->isEmpty())
            <div class="empty-rooms">
                ...
                <p>Belum ada pesan.<br>Chat terbuka setelah pendaftaranmu dikonfirmasi.</p>
            </div>
        @else
            <div class="rooms">
                @foreach($rooms as $room)
                    ...
                    <a href="{{ route('volunteer.chat.show', $room) }}"
                       class="room-item {{ request()->route('room')?->id === $room->id ? 'active' : '' }}">
                        ...
                        <div class="room-info">
                            <div class="room-top">
                                <div class="room-name {{ $hasUnread ? 'bold' : '' }}">{{ $orgName }}</div>
                                @if($timestamp)
