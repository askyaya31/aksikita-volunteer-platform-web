...
<div style="max-width:680px; margin:0 auto; padding:2rem 1.5rem;">
    ...
    @forelse($rooms as $room)
        ...
        <a href="{{ route('volunteer.chat.show', $room) }}"
           style="display:flex; align-items:center; gap:13px;
                  ...
                  {{ $hasUnread ? 'background: var(--color-blue-ghost);' : '' }}"
           ...
           onmouseout="this.style.boxShadow='none'">
            ...
            <div style="flex:1; min-width:0;">
                <div style="display:flex; align-items:center;
                    ...
                    @if($timestamp)
                        <div style="font-size:0.72rem; color:{{ $hasUnread ? 'var(--color-blue)' : 'var(--color-ink-muted)' }};
                                    white-space:nowrap; flex-shrink:0; font-weight:{{ $hasUnread ? '600' : '400' }};">
                            {{ $timestamp }}
                        </div>
                    @endif
                </div>
    ...
    @empty
        <div style="text-align:center; padding:4rem 1rem;">
            ...
            <p style="font-size:0.875rem; color:var(--color-ink-muted); margin:0;
                      line-height:1.6;">
                Belum ada pesan.<br>
                Chat terbuka setelah pendaftaranmu dikonfirmasi organisasi.
            </p>
        </div>
    @endforelse
