...
<body class="ak-fadein">
    ...
    <nav class="ak-navbar" id="adminNavbar">
        <div style="width:100%; padding-inline:24px; display:flex; align-items:center; gap:12px;">
            ...
            <span class="ak-badge ak-badge-navy" style="font-size:11px;">Admin</span>
            ...
            <div style="margin-left:auto; display:flex; align-items:center; gap:12px;">
                ...
                <div class="ak-user-menu" id="adminUserMenu">
                    <button class="ak-user-menu__trigger" id="adminUserTrigger" aria-haspopup="true" aria-expanded="false">
                        <span class="ak-avatar" style="background: linear-gradient(135deg, #152d6b 0%, #1E3A8A 100%);">
                    ...
                    <div class="ak-user-menu__dropdown" id="adminUserDropdown" role="menu">
                        <div style="padding:10px 12px 8px; border-bottom:1px solid var(--color-border); margin-bottom:4px;">
                            ...
                            <span class="ak-badge ak-badge-navy" style="font-size:10px; margin-top:4px; display:inline-flex;">Administrator</span>
                        </div>
    ...
    <aside class="ak-sidebar" id="adminSidebar" aria-label="Navigasi admin">
        ...
        <a href="{{ route('admin.dashboard') }}"
           class="ak-sidebar-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.users') }}"
           class="ak-sidebar-link {{ request()->routeIs('admin.users') && !request()->get('role') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('admin.users') }}?role=volunteer"
           class="ak-sidebar-link {{ request()->routeIs('admin.users') && request()->get('role') === 'volunteer' ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('admin.users') }}?role=organization"
           class="ak-sidebar-link {{ request()->routeIs('admin.users') && request()->get('role') === 'organization' ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('admin.events') }}"
           class="ak-sidebar-link {{ request()->routeIs('admin.events') && !request()->get('status') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('admin.events') }}?status=pending_review"
           class="ak-sidebar-link {{ request()->routeIs('admin.events') && request()->get('status') === 'pending_review' ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- <a href="{{ route('admin.reports') }}"
           class="ak-sidebar-link {{ request()->routeIs('admin.reports*') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- <a href="{{ route('admin.statistics') }}"
           class="ak-sidebar-link {{ request()->routeIs('admin.statistics*') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        {{-- <a href="{{ route('admin.notifications') }}"
           class="ak-sidebar-link {{ request()->routeIs('admin.notifications*') ? 'active' : '' }}">
            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/>
            </svg>
            Notifikasi
        ...
        <div style="margin-top:auto; padding-top:16px; border-top:1px solid var(--color-border);">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
