...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ak-nav-link:hover { color: #1A3A6B; background: #f5f5f5; }
        .ak-nav-link.active { color: #1A3A6B; font-weight: 700; }
        ...
        .ak-footer__col-links a { 
            font-size: 0.84rem; 
            color: rgba(255, 255, 255, 0.7) !important; 
            text-decoration: none; 
            transition: color .15s; 
        }
        .ak-footer__col-links a:hover { color: #fff !important; text-decoration: underline; }
...
<body class="ak-fadein">
            ...
            <div class="ak-nav-right">
                ...
                <div class="ak-user-menu" id="volUserMenu">
                    ...
                    <div class="ak-user-menu__dropdown" id="volUserDropdown" role="menu">
                        ...
                        <a href="{{ route('volunteer.saved-events') }}" class="ak-dropdown-item" role="menuitem">
                            <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"/>
                            </svg>
                            Tersimpan
                        </a>
                        <a href="{{ route('volunteer.history') }}" class="ak-dropdown-item" role="menuitem">
    ...
    <main style="min-height: calc(100vh - 60px); margin-top: 60px; display: inline-block; width: 100%; vertical-align: top;">
