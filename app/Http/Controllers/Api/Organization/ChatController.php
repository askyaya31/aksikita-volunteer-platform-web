...
class ChatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $rooms = ChatRoom::with([
            ...
            ->map(fn($room) => [
                ...
                'organizerName'   => $room->volunteer?->name ?? '',     
                'organizerLogo'   => $room->volunteer?->volunteerProfile?->avatar
                                        ? Storage::url($room->volunteer->volunteerProfile->avatar)
                                        : null,
    ...
    public function unreadCount(Request $request)
    {
        ...
        $count = ChatRoom::where('organizer_id', $userId)
            ->get()
